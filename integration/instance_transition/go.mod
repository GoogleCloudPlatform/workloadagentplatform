module github.com/GoogleCloudPlatform/workloadagentplatform/integration/instance_transition

go 1.24

replace github.com/GoogleCloudPlatform/workloadagentplatform/integration/instance_transition/cmd v0.0.0 => ./cmd

replace github.com/GoogleCloudPlatform/workloadagentplatform/integration/instance_transition/service v0.0.0 => ./service

replace github.com/GoogleCloudPlatform/workloadagentplatform/integration/instance_transition/protos v0.0.0 => ./protos

replace github.com/GoogleCloudPlatform/workloadagentplatform/integration/instance_transition/onetime v0.0.0 => ./onetime

replace github.com/GoogleCloudPlatform/workloadagentplatform/integration/instance_transition/usagemetrics v0.0.0 => ./usagemetrics

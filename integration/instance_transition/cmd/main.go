...
// Package main serves as the Main entry point for the Google Cloud Instance Transition Agent.
package main
...
import (
	...
	"github.com/GoogleCloudPlatform/workloadagentplatform/integration/instance_transition/onetime/compute"
	"github.com/GoogleCloudPlatform/workloadagentplatform/integration/instance_transition/onetime/echo"
	"github.com/GoogleCloudPlatform/workloadagentplatform/integration/instance_transition/service"
...
var agentIntegration = &cpb.Integration{
	IntegrationName: `instance_transition`,
	AgentName:       `google-cloud-instance-transition-agent`,
	AgentBinaryName: `google_cloud_instance_transition_agent`,
	AgentLongName:   `Google Cloud Instance Transition Agent`,
...
func registerSubCommands(ctx context.Context, lp log.Parameters, cp *cpb.CloudProperties) {
	...
	rootCmd.AddCommand(compute.NewComputeCmd(ctx, lp, cp, agentIntegration))

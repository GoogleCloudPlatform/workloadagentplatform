...
// Package service contains all of the code for the instance_transition agents services.
package service
...
import (
	...
	epb "github.com/GoogleCloudPlatform/workloadagentplatform/integration/instance_transition/protos"
)
...
const (
	...
	LinuxConfigPath = `/etc/google-cloud-instance-transition-agent/configuration.json`
	// WindowsConfigPath is the default path to agent configuration file on windows.
	WindowsConfigPath = `C:\Program Files\Google\google-cloud-instance-transition-agent\conf\configuration.json`
)
